...
export function Checkbox() {
    return (
        ...
        <div class="flex items-center py-5">
            <input type="checkbox" className="w-4 h-4 checked text-green-500 bg-gray-100 border-gray-300 rounded dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"></input>
