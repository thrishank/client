export function Right(){
    return(
        <div className="bg-black h-full">
            <div>
                <img className="" src="/photo-1.jpeg" height="697px" width="1006px"/>
            </div>
            ...
            <div className="flex p-2 m-2">
                <div className="flex flex-col text-gray-300 p-1 m-1">
                    <img src="/filelist2line-1.svg" width="56px" height="56px"/>
                    <div className="m-1">Listing your home for sale</div>
                </div>
                <div className="flex flex-col text-gray-300 p-1 m-1">
                    <img src="public\searcheyeline-1.svg" width="56px" height="56px"/>
                    <div className="m-1">Finding homes for you to buy</div>
                </div>
                <div className="flex flex-col text-gray-300 p-1 m-1">
                    <img src="public\storeline-1.svg" width="56px" height="56px"/>
                    <div className="m-1">Providing you with market information</div>
                </div>
                <div className="flex flex-col text-gray-300 p-1 m-1">
                    <img src="public\coinsline-1.svg" width="56px" height="56px"/>
